...
- 🎭 **Filtro por gênero** (20+ categorias)
- ⭐ **Ordenação personalizada** (melhor avaliados, mais recentes, etc.)
...
**⚠️ VIEW-ONLY LICENSE - NOT OPEN SOURCE**

This project is shared as a **portfolio demonstration** under a **view-only license**.

✅ **Allowed for:** Study, learning, portfolio reference  
